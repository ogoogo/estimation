function calculate_data_sunsensor(equ_source_name,output_name,celestial, id,f)
...
for i = -10:0.5:10
    ...
    % ベクトルの回転
    rotated_sun_dlp(1:2) = R * v;
    rotated_sun_dlp(3) = sun_dlp(3);
    dcm4(1,1) = i;
    inforow = [id, et, r_equ, l_moon, l_sun, dcm4(1,:), dcm4(2,:), dcm4(3,:), dlp_dcm(1,:), dlp_dcm(2,:), dlp_dcm(3,:), rotated_sun_dlp, dcm_moon, cele_dlp, coefficient, coefficient_term, dlp_dcm2(1,:), dlp_dcm2(2,:), dlp_dcm2(3,:),];
